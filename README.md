...
## Устарело
В настоящее время обновленная файловая система и драйвер SD перенесены в новые репозитории.
- [mik32sd](https://github.com/Barsy-Barsevich/mik32sd)
- [mik32fat](https://github.com/Barsy-Barsevich/mik32fat)
